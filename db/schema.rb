...
ActiveRecord::Schema[7.0].define(version: 2026_09_24_090100) do
  ...
  create_table "glossaries", force: :cascade do |t|
    ...
    t.index ["source_language_code", "target_language_code"], name: "index_glossaries_on_language_pair", unique: true
  end
  ...
  create_table "terms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["glossary_id", "source_term"], name: "index_terms_on_glossary_id_and_source_term"
  end
